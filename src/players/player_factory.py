...
class PlayerFactory:
    ...
    def create_player(player_type: str, name: str, turn_played_sem: Semaphore, current_player_idx: int,
                      player_index: int, password: str = None, is_observer: bool = None) -> Player:
        player_class = PlayerFactory.__PLAYER_TYPES[player_type]
        return player_class(name, password, is_observer, turn_played_sem, current_player_idx, player_index)
